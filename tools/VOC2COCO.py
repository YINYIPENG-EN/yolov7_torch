...
if __name__ == '__main__':
    # xml标注文件夹
    xml_dir = '../data/datasets/VOCdevkit/VOC2007/Annotations'
    # 训练数据的josn文件
    save_json_train = '../data/datasets/coco/train.json'
    # 验证数据的josn文件
    save_json_val = '../data/datasets/coco/val.json'
    # 验证数据的test文件
    save_json_test = '../data/datasets/coco/test.json'
    ...
    xml_list = glob.glob(xml_dir + "/*.xml")  # 获得所有xml文件
    xml_list = np.sort(xml_list)  # 排序
